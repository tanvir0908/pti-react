    ...
    <div className="bg-primary flex pb-20 px-5 md:px-10 xl:px-0">
      <div className="flex-1 lg:pl-[22rem] mt-[5rem]">
        <div className="bg-white lg:w-[45rem] px-1 rounded-xl flex items-center justify-between">
          <input
            className="outline-none font-medium px-3 py-3 rounded-xl"
            type="text"
        ...
        <div className="gap-5 items-center flex md:hidden mt-10 justify-center">
          <FaGoogle
            size={40}
        ...
        <div className=" mt-20 lg:mt-32">
          <h2 className="text-black text-center lg:text-left font-secondary text-3xl md:text-4xl font-semibold">
